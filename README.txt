...
Open the file in4073\Makefile using any text editor and enter the COM port number of FCB under "upload" and "upload-run" command. 
For example, the code snippet after adding prefix looks like:
...
Open command prompt and naviage to in4073 folder. Type "make upload-run" and press enter. 
The code should compile and upload to the FCB. 

On successful compilation and upload of the program, the data sent from FCB should be displayed on command prompt at 115200 baud. 
(Any serial terminal program (example: Putty) can be used instead of provided pc_terminal program)
